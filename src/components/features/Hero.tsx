...
export function Hero() {
    return (
        <section className="relative w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-[url('https://images.unsplash.com/photo-1499636138143-bd630f5cf446?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center">
            ...
            <div className="container relative px-4 md:px-6 flex flex-col items-center text-center space-y-4">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none text-white">
                    Galletas que encantan, Sabores que inspiran: <br className="hidden md:inline" />
                    <span className="text-primary-foreground">hechas a tu medida!</span>
                </h1>
