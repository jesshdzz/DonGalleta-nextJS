...
export function CartItemRow({ item }: CartItemRowProps) {
    ...
    return (
        <Card className={`flex flex-col sm:flex-row overflow-hidden border-border/60 shadow-sm transition-all ${isInvalid ? 'opacity-60 bg-secondary/10 border-destructive/30' : ''}`}>
            {/* Imagen del Item */}
